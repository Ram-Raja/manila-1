...
its configuration efficiently in an already available distributed storage sytem.
Set additional options in the NFS driver section to enable the driver to do
this.
